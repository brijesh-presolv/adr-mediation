...
<html>
    ...
    <h4 class="text-center">Enlisted by the Department of Justice, Government of India and empaneled as a Mediation Institution by various Courts in India</h4>
    ...
    <p>1.   Desirous of arriving at an amicable resolution, the Initiating Party has approached ‘Presolv360’ to facilitate an amicable settlement of your dispute.</p>
    ...
    <p>4.   The mediation / conciliation shall be governed by and conducted in accordance with Presolv360’s Dispute Resolution Rules, a copy of which can be found 
        <a href='https://drive.google.com/file/d/1a5GkQA0KX_4-gUDf25D0uU7Rt_1S8DDl/view?usp=sharing'>here</a></p>

    <p>5.   While the process is absolutely confidential, the mediation / conciliation proceedings are ‘without prejudice’ to any legal remedies available in the event of non-participation or if the dispute remains unresolved. This has become one of the most rewarding processes, with a success rate of over 90% of all references being made.</p>

    <p>6.   The Responding Party shall, within seven (7) Working Days from the receipt of the Invitation to Mediate / Conciliate, accept or reject the said invitation by way of an email addressed to Presolv360 at admin@presolv360.com, failing which, the mediation / conciliation shall deemed to be a non-starter.
    </p>
    ...
    <p>8.  As per Rule 6 of Section 3 of its Dispute Resolution Rules, Presolv360 shall appoint a mediator / conciliator from its panel of mediators / conciliators, and such appointment shall be based on the mediator’s / conciliator’s competence, knowledge and ability to deal with subject matter of the dispute between the parties.</p>

    <p>9.   Upon acceptance of the appointment by the mediator / conciliator, the parties shall be notified of the appointment.</p>
    <br /><br /><br />

    <p><b>Note: This is a system generated notice and hence does not require signature.</b></p>
    <table cellspacing="0" cellpadding="10" width="100%">
        <tr>
            <td ><p>To:</p><p>Responding Party</p></td>
