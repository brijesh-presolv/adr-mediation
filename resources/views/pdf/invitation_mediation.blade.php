...
.table_ th{
    ...
    <body>
        ...
        <img src='{{URL("assert/img/logo_mediacje.png")}}' style='width: 200px;'>
        <br><br><br>
    </div>
    </center>
    ...
    <a href='https://www.presolv360.com/important_documents'>here</a></p>
