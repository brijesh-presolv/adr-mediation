...
<body>
    ...
    <p style="">7. The Institution can also be requested to provide a list of available mediators from its panel of mediators, by way of an email 
        addressed to admin@presolv360.com with the subject "Request for List of Available Mediators | (Case ID)". 
        The parties shall mutually appoint a mediator from the said list, failing which, a mediator from the aforesaid list shall be confirmed by the Institution in accordance with the Rules.</p>
