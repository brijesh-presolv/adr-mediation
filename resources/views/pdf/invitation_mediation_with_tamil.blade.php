...
<body>
    ...
    <p class="text-center" style="font-size:30px; margin-bottom: 0px; margin-top: 0px;">மத்தியஸ்தம்/சமரசம் </p>
    <p class="text-center" style="font-size:30px; margin-bottom: 0px; margin-top: 0px;">செய்துகொள்வதற்கானஅழைப்பு</p>

    <p class="text-center" style="font-size:20px; margin-bottom: 0px; margin-top: 0px;">ஆன்லைன் தகராறு தீர்வு (ODR) மூலம் உள்ளிட்ட மாற்று தகராறு தீர்வு (ADR) சேவைகளை நோக்குநிலைப்படுத்தும் நிறுவனங்களின் பட்டியலில் <a
