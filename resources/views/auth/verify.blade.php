        ...
        <div class="container ">
                    ...
                    <div class="card-body">
                            ...
                            <div class="tab-content ">
                                <div class="tab-pane active" id="otp">
                                <br>
                                <h5><center>Please Enter OTP</center></h5>
                                <hr>
                                <form role="form" class="form-horizontal loginformsection" method="POST" action="">
                                        @csrf
                                        ...
                                        <div class="row mobtns">
                                            <div class="col-md-12" style="display:inline-block; text-align: center;">
                                                <button type="submit" class="btn btn-warning btn-lg btnmobile mt-2 dwidth" style="background-color: #FFA600;border: 1px;">
                                                    Submit</button>
                                                <button type="button" class="btn btn-warning btn-lg btnmobile mt-2 dwidth2" style="background-color:#0B5386;border: 1px;"  id="resendotp" data-id="{{Auth::user()->username}}">Resend</button>
                                            </div>
