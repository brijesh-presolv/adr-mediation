            ...
            <div class="text-center card-box shadow-none border border-secoundary">
                <div class="member-card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered m-0">
                            ...
                            <thead>
                                <tr>
                                    <td colspan="4" class="bg-dark text-center text-white">Admin Profile</td>
                                </tr>
                            </thead>
                ...
                <div id="custom-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        ...
                        <form action = "{{ route('admin.profile.update',['id'=> $profileData->id]) }}" method = "post">
                            <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                            <input type = "hidden" name = "profileID" value = "{{ $profileData->id }}">

                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title mt-0">Admin Profile</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('admin.change.password',['id'=> $profileData->id]) }}" class="btn-sm btn-warning px-2" >Change Password </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
