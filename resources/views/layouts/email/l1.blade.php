@section('title','Thank you for choosing Mediation')
@extends('email.layouts.app')
@section('content')
<p>Dear Customer,</p>

<p>We thank you for choosing Mediation as your preferred partner for dispute management. </p>

<p>We have received your case details and are working on it. You can also opt for an initial consultation with our experts by booking an appointment with us at {{config('email.info','info@appname.com')}}</p>
...
<p>Best regards,</p>
<p>Team {{ config('app.name', 'Mediation') }}</p>
