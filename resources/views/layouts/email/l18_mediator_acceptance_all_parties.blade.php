@section('title','Urgent: Mediator's Consent and Disclosures')
@extends('email.layouts.app')
@section('content')
<p>Dear Party,</p>
<p>The Mediator appointed in respect of your mediation having case ID {{$id}} has intimated
the acceptance and submitted the consent and necessary disclosures. The same is enclosed alongwith
this mail and can also be viewed on the platform by clicking here <a href="{{route("login")}}">{{route("login")}}</a>.</p>
