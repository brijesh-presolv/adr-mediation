@section('title','Unable to process your case')
@extends('email.layouts.app')
@section('content')
<p>Dear Customer,</p>

<p>We regret to inform you that we are unable to process the case you have submitted. We hope to have a chance of serving you again!</p>
