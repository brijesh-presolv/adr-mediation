...
<section class="tabs-section">
    ...
    <div id="myModalbupldCourierAdmin" class="mdladcm modal fade " role="dialog" data-keyboard="false" data-backdrop="static">
                    ...
                    <div class="blkfrmdiv" style="width: 100%;">
                        ...
                        <form enctype="multipart/form-data" id="myModalbupldCourierAdminForm" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="type" id="type" placeholder="Type" class="col-md-12 form-control" required="" />
                            </div>
                            <div class="form-group">
                                <input type="file" name="csv" id="fileInput" onchange="" data-allowed-file-extensions="csv" class="col-md-12 dropify" required="" data-max-file-size="20M" />
                            </div>
    ...
    <div id="myModalbupldCourierzipAdmin" class="mdladcm modal fade " role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
                ...
                <div class="modal-header">
                    ...
                    <div class="blkfrmdiv" style="width: 100%;">
                        ...
                        <form enctype="multipart/form-data" id="myModalbupldCourierzipAdminForm" method="post">
                            ...
                            <div class="form-group">
                                <input type="file" name="zip" id="fileInput" onchange="" data-allowed-file-extensions="zip" class="col-md-12 dropify" required="" data-max-file-size="20M" />
                            </div>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active show" id="tabs-2-tab-3">
            <div class="card-box table-responsive">
                ...
                <table id="usersbulk" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <label class="checkbox-inline" style="float: left;margin-right: 10px;margin-top:10px;"><input type="checkbox" id="selectalldirBulkcases"> Select All Cases</label>

                    </div>
                    <div class="col-md-10">
                        <button class="blkbtn btn btn-teal waves-light waves-effect btn-sm" data-toggle="modal" data-target="#withdrawModalForBulk" id="bulkCloseBtnBulkcases" style="margin-top:10px; display:none;" data-arb="<?= Auth::user()->id ?>">Bulk
                            Close</button>
                        <button class="blkbtn btn btn-primary btn-sm" data-toggle="modal" data-target="#uploadSupportingDocsModalForBulk" id="bulkUploadBulkcases" style="margin-top:10px; display:none;" data-arb="<?= Auth::user()->id ?>">Upload
                            Supporting
                            Documents</button>
                        <button class="btn btn-pink waves-effect waves-light btn-sm" data-toggle="modal" data-target="#addSessionModelForBulk" id="bulkSessionBulkcases" style="margin-top:10px; display:none;" data-arb="<?= Auth::user()->id ?>"><span class="mdi mdi-pencil-plus"></span></button>
                        <button class="blkbtn btn btn-primary btn-sm" id="bulkdownloadBulkcases" style="margin-top:10px; display:none;">Bulk Download</button>
                        <button class="blkbtn btn btn-primary btn-sm" id="downloadExcelBulkcases" style="margin-top:10px; display:none;">Download Invitation Delivery Sheet</button>
        ...
        <div role="tabpanel" class="tab-pane fade " id="tabs-2-tab-1">
            <div class="card-box table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <button class="blkbtn btn btn-teal waves-light waves-effect btn-sm" data-toggle="modal" data-target="#withdrawModalForBulk" id="bulkCloseBtn" style="margin-top:10px; display:none;" data-arb="<?= Auth::user()->id ?>">Bulk
                            Close</button>
                        <button class="blkbtn btn btn-primary btn-sm" data-toggle="modal" data-target="#uploadSupportingDocsModalForBulk" id="bulkUpload" style="margin-top:10px; display:none;" data-arb="<?= Auth::user()->id ?>">Upload
                            Supporting
                            Documents</button>
                        ...
                        <button class="blkbtn btn btn-primary btn-sm" id="bulkdownload" style="margin-top:10px; display:none;">Bulk Download</button>
                        <button class="blkbtn btn btn-primary btn-sm" id="downloadExcel" style="margin-top:10px; display:none;">Download Invitation Delivery Sheet</button>
...
<div id="Session-edit" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true" class="modal-demo">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form id="UpdateSessionForm">
                ...
                <div class="custom-modal-text ">
                    <div class="form-group">
                        <label>@lang('case.session_date') :</label>
                        <input type="text" autocomplete="off" id="editsessionDate" class="form-control" name="sessionDate" placeholder="@lang('case.session_date_placeholder')" data-validation="required">
                    </div>
                    <div class="form-group">
                        <label>@lang('case.session_time'):</label>
                        <input type="time" id="editsessionTime" value="16:04" autocomplete="off" class="form-control" name="sessionTime" placeholder="@lang('case.session_time_placeholder')" data-validation="required">
                    </div>
                    <div class="form-group">
                        <label>@lang('case.session_zoom_id') :</label>
                        <input type="text" id="editzoomId" class="form-control" name="zoomId" placeholder="@lang('case.session_zoom_id_placeholder')" data-validation="required">
                    </div>
                    <div class="form-group">
                        <label>@lang('case.session_note'):</label>
...
<div id="Session-delete" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true" class="modal-demo">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="post">
                ...
                <div class="custom-modal-text ">
                    ...
                    <div class="text-right">
                        <button type="button" class="btn-sm btn mt-3  btn-secondary" data-dismiss="modal">Close</button>
                        <input type="button" id="sessiondeleteform" name="deleteSession" class="btn-sm btn btn-primary mt-3" value="Submit">
                    </div>
                </div>
            </form>
        </div>
...
<div id="Session-delete-reason" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true" class="modal-demo">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<!------------- Minute modal : START ---------------------->
<div class="modal fade" id="minuteModal" tabindex="-1" aria-labelledby="minuteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="minuteModalLabel">@lang('case.minutes_heading')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="minuteForm" method="post">
                <div class="modal-body">
                    <input type="hidden" name="case_id" class="form-control">
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Minutes:</label>
                        <select class="form-control" name="status" required>
                            <option value="">---Select Minutes---</option>
                            @foreach ($minutes_records as $minutes_record)
                            <option value="{{$minutes_record->id}}">{{$minutes_record->minutes_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('case.btn_close')</button>
                    <button type="submit" class="btn btn-primary">@lang('case.btn_minutes_submit')</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="reportModalLabel">@lang('case.reports_heading')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="reportForm" method="post">
                <div class="modal-body">
                    <input type="hidden" name="case_id" class="form-control">
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Reports:</label>
                        <select class="form-control" name="status" required>
                            <option value="">---Select Reports---</option>
                            @foreach ($reports_records as $reports_record)
                            <option value="{{$reports_record->id}}">{{$reports_record->minutes_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('case.btn_close')</button>
                    <button type="submit" class="btn btn-primary">@lang('case.btn_reports_submit')</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
        ...
        "columns": [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    button = button + `<button value="` + data + `"  data-id="` + data +
                        `" data-toggle="modal" data-target="#withdrawModal"    class="btn btn-teal waves-light waves-effect btn-sm">@lang('case.btn_close')</button><br>`;
                    /************ For Minutes & Reports : START  ******************************/
                    button = button + `<button value="` + data + `"  data-id="` + data +
                        `" data-toggle="modal" data-target="#minuteModal"    class="btn btn-purple waves-light waves-effect btn-sm">@lang('case.btn_minutes')</button><br>`;
                    button = button + `<button value="` + data + `"  data-id="` + data +
                        `" data-toggle="modal" data-target="#reportModal"    class="btn btn-pink waves-light waves-effect btn-sm">@lang('case.btn_reports')</button>`;
                    /************ For Minutes & Reports : END  ******************************/
                    return button;
                }
            },
            {
    ...
    /********* minute modal : START ************/
    $('#minuteModal').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget);
        var recipient = button.data('id');
        var modal = $(this)
        modal.find('.modal-body input[name="case_id"]').val(recipient);
    ...
    $('#minuteForm').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
            type: 'post',
            url: '{{ route("admin.minutes.minuteAdd") }}',
            ...
            success: function(resp) {
                var title_text;
                var input_type;
                var last_insert_id = resp.last_insert_id;
                var note_value;
                var field_type;
                var days_value;
                var file_value;
                var case_id = resp.case_id;
                ...
                if(resp.type == "Note"){
                    ...
                    content: {
                        ...
                        if (result) {
                           var note_value = document.querySelector(".swal-content__textarea").value;
                           var days_value = "";
                           var file_data = [];
                           var file_value = "";
                           ajax_minute_report_data(last_insert_id, note_value, days_value, file_data, file_value, case_id);
                       }
                    });

                } else if(resp.type == "Days"){
                    ...
                    content: {
                        ...
                        if (result) {
                            var days_value = document.querySelector(".swal-content__input").value; 
                            var note_value = "";
                            var file_data = [];
                            var file_value = "";
                            ajax_minute_report_data(last_insert_id, note_value, days_value, file_data, file_value, case_id);
                    ...
                    content: {
                        ...
                        if (result) {
                            var file_data = document.querySelector(".swal-content__input").files[0]; 
                            var file_value = file_data.name;
                            //console.log(file_value);
                            //console.log(file_value.name);
                            // return false;
                            var note_value = "";
                            var days_value = "";
                            ajax_minute_report_data(last_insert_id, note_value, days_value, file_data, file_value, case_id);
    ...
    //             swal("@lang('case.minute_ongoing_add_successfully')", {
    //                 icon: "success",
    //             }).then(function() {
    //                 location.reload();
    //             });
    ...
    function ajax_minute_report_data(last_id, note_value, days_value, file_data, file_value, case_id){
        ...
        $.ajax({
           ...
           processData: false,  // Important!
            contentType: false,
           // cache: false,
            url: "{{ route('admin.minutes.minuteEdit') }}",
            data: {
