                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="useraddress" class="form-control"
                                    value="<?= $user->address1 != 'NULL' ? $user->address : '' ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Address line 2</label>
                                <input type="text" name="useraddress1" class="form-control"
                                    value="<?= $user->address1 != 'NULL' ? $user->address1 : '' ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="usercity" class="form-control"
                                    value="<?= $user->city != 'NULL' ? $user->city : '' ?>" required
                                    data-smk-msg="Enter valid city">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="userpincode" class="form-control"
                                    value="<?= $user->pincode != 'NULL' ? $user->pincode : '' ?>" required minlength="6"
                                    maxlength="10" data-smk-msg="Enter vaild pincode"
                                    data-smk-pattern="[a-zA-Z0-9\s-]{5,10}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="userstate" class="form-control"
                                    value="<?= $user->state != 'NULL' ? $user->state : '' ?>" required=""
                                    data-smk-msg="Enter valid state" list="stateData">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Country <span style="color:red; ">*</span></label>
                                <input type="text" list="countryData" name="usercountry" class="form-control"
                                    value="<?= $user->country != 'NULL' ? $user->country : '' ?>" required
                                    data-smk-msg="Enter valid country">
                            </div>
                        </div>
                    </div>
                </section>
            ...
            for ($i = 0; $i < $rowcount; $i++) {
                ...
                @if ($i != 0)
                    @if (isset($InvoledUser[$i]))
                        ...
                        <section class="respondent" id="{{ 'rowid' . ($i) }}">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="respcount">#<?= $i ?></h6>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Name<span style="color:red; ">*</span></label>
                                        <input type="text" name="name[]" class="form-control"
                                            value="<?= isset($InvoledUser[$i]['name']) ? $InvoledUser[$i]['name'] : '' ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email[]" class="form-control"
                                            value="<?= isset($InvoledUser[$i]['userEmail']) ? $InvoledUser[$i]['userEmail'] : '' ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone[]" class="form-control"
                                            value="<?= isset($InvoledUser[$i]['userPhone']) ? $InvoledUser[$i]['userPhone'] : '' ?>"
                                            minlength="8" maxlength="15" data-smk-pattern="[0-9\s-+]{8,15}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Type of Party</label>
                                        <select id="selected_paty" name="selected_party[]" class="form-control selected_paty">
                                            <option value="0" <?= ($InvoledUser[$i]['isClaimant'] == 0) ? "selected" : ""?>>Initiating Party</option>
                                            <option value="1" <?= ($InvoledUser[$i]['isClaimant'] != 0) ? "selected" : ""?>>Responding Party</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="add1[]" type="text" class="form-control"
                                                value="<?= isset($InvoledUser[$i]['address1']) ? $InvoledUser[$i]['address1'] : '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="add2[]" type="text" class="form-control"
                                                value="<?= isset($InvoledUser[$i]['address2']) ? $InvoledUser[$i]['address2'] : '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="city[]" type="text" class="form-control"
                                                value="<?= isset($InvoledUser[$i]['city']) ? $InvoledUser[$i]['city'] : '' ?>"
                                                data-smk-msg="Enter valid city">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="pincode[]" type="text" class="form-control"
                                                value="<?= isset($InvoledUser[$i]['pincode']) ? $InvoledUser[$i]['pincode'] : '' ?>"
                                                minlength="5" maxlength="10" data-smk-msg="Enter vaild pincode"
                                                data-smk-pattern="[a-zA-Z0-9\s-]{5,10}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>State <span style="color:red; ">*</span></label>
                                            <input name="state[]" list="stateData" type="text" class="form-control"
                                                value="<?= isset($InvoledUser[$i]['state']) ? $InvoledUser[$i]['state'] : '' ?>"
                                                data-smk-msg="Enter valid state">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Country <span style="color:red; ">*</span></label>
                                            <input list="countryData" name="country[]" type="text"
                                                class="form-control"
                                                value="<?= isset($InvoledUser[$i]['country']) ? $InvoledUser[$i]['country'] : '' ?>"
                                                data-smk-msg="Enter valid country">
                                            <input type="hidden" name="invid[]" class="form-control"
                                                value="{{ $InvoledUser[$i]['id'] }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <button class="btn badge badge-danger removeresp"
                                            data-id="{{ 'rowid' . ($i) }}"
                                            data-ivid="{{ $InvoledUser[$i]['id'] }}">Remove</button>
                                    </div>
                                </div>
                            @else
                                <div class="row lastsection">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="<?= public_path('mediation') . '/' . $medcase->id . '/' . $medcase->documentPath ?>"
                                    class="btn badge badge-success">Supporting Document</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#addmore', function(e) {
                ...
                resp.find('.respcount').text('#' + rowid);
                resp.find('.removeresp').attr('data-id', 'rowid' + rowid);
                resp.find('.form-control').val('');
                resp.find('.selected_paty option[value=1]').attr('selected','selected');
