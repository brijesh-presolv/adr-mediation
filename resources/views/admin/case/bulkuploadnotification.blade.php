...
@section('title', "Bulk Upload Supporting Documents Notifications")

@section('breadcrumb')
<!-- start page title -->
<li class="breadcrumb-item"><a href="javascript: void(0);">@lang('case.home')</a></li>
<li class="breadcrumb-item"><a href="javascript: void(0);">Bulk Upload Supporting Documents Notifications</a></li>
<!-- end page title -->
@endsection
@section('page_title', "Bulk Upload Supporting Documents Notifications")
            ...
            <div class="row">
                <form id="batchSubmitClose">
                    <div class="form-group">
                        <label>Select the Batch in which bulk upload supporting documents case notification will be disabled</label>
                        <br>
                    ...
                    <div class="form-group">
                        <label for="">Disable notification when bulk supporting documents are uploaded</label>
                        <br>
...
<script>
    $(document).ready(function(){
        $('#batchSubmitClose').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('admin.case.batchNotificationStopWhenBulkDocument') }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
