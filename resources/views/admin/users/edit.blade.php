                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name"
                                    value="{{ $user->first_name }}" data-validation="required">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="last_name">@lang('user.last_name')</label>
                                <input type="text" class="form-control" id="last_name" name="last_name"
                                    value="{{ $user->last_name }}" data-validation="required">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="email">@lang('user.email')</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    value="{{ $user->email }}" data-validation="required email">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="username">@lang('user.username')</label>
                                <input type="text" class="form-control" id="username" name="username"
                                    value="{{ $user->username }}" data-validation="required">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="mobile_number">@lang('user.phone')</label>
                                <input type="text" class="form-control" id="mobile_number" name="mobile_number"
                                    value="{{ $user->mobile_number }}" data-validation="required custom length"
                                    data-validation-length="8-15" data-validation-regexp="^([0-9\s+-]+)$">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="organization">@lang('user.organization')</label>
                                <input type="text" class="form-control" id="organization" name="organization"
                                    value="{{ $user->organization }}"
                                    data-validation=" @if ($user->role == 1) required @endif">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input list="countryData" class="form-control" id="country" name="country"
                                    value="{{ $user->country }}" data-validation="required length"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input list="stateData" class="form-control" id="state" value="{{ $user->state }}"
                                    name="state">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" id="pincode" name="pincode"
                                    value="{{ $user->pincode }}" data-validation="required">
                            </div>
                            ...
                            @if ($user->role == 1)
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="select2 form-control select2-multiple" multiple="multiple"
                                        data-placeholder="" id="area_of_specialization" name="area_of_specialization[]"
                                        required>
                                        ...
                                        @foreach ($areaOfSpecialization as $specialization)
                                            <option value="{{ $specialization->name }}"
                                                {{ isset($medi->area_of_specialization) &&array_search($specialization->name, json_decode($medi->area_of_specialization)) !== false? 'selected': '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="no_of_arbitrations" name="no_of_arbitrations">
                                        ...
                                        <option
                                            {{ isset($medi->no_of_arbitrations) && $medi->no_of_arbitrations == '0 – 5' ? 'selected' : '' }}>
                                            0 – 5</option>
                                        <option
                                            {{ isset($medi->no_of_arbitrations) && $medi->no_of_arbitrations == '6 – 10' ? 'selected' : '' }}>
                                            6 – 10</option>
                                        <option
                                            {{ isset($medi->no_of_arbitrations) && $medi->no_of_arbitrations == '11 – 25' ? 'selected' : '' }}>
                                            11 – 25</option>
                                        <option
                                            {{ isset($medi->no_of_arbitrations) && $medi->no_of_arbitrations == '25 – 50' ? 'selected' : '' }}>
                                            25 – 50</option>
                                        <option
                                            {{ isset($medi->no_of_arbitrations) && $medi->no_of_arbitrations == 'Above 50' ? 'selected' : '' }}>
                                            Above 50</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="linked_in_profile_link">@lang('user.linkedin_profile_link')</label>
                                    <input type="url" class="form-control" id="linked_in_profile_link"
                                        value="{{ isset($medi->linked_in_profile_link) ? $medi->linked_in_profile_link : '' }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="experience" name="experience"
                                        required>{{ isset($medi->experience) ? $medi->experience : '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @if ($user->profile_pic != null)
                                        <br><img width="12%"
                                            src="{{ Config::get('constants.mediator_path') }}/{{ $user->id }}/profile/{{ $user->profile_pic }}" />
                                    @endif
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="status" class="form-control">
                                    <option {{ isset($user->isDone) && $user->isDone == '1' ? 'selected' : '' }} value="1">
                                        @lang('user.approve')</option>
                                    <option {{ isset($user->isDone) && $user->isDone == '0' ? 'selected' : '' }} value="0">
                                        @lang('user.unapprove')</option>
