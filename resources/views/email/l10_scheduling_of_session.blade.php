@section('title','Your resolution session has been scheduled')
...
<p>Based on the confirmation received from the parties, the resolution session for your case bearing ID {{$id}} has been scheduled.   </p>

<p>Kindly login to the dashboard to view the details by clicking here {{url('/user/ongoing/')}}. </p>

<p>Please note that you may need to download the video conference application specified for this purpose. Once you click on the relevant Video ID link on the dashboard, the process will follow through thereafter. </p>
