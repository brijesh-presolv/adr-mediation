...
class DashboardController extends Controller
{
    ...
    public function getNotifications()
    {
        ...
        $noficationdata = Notification::usernotificationAPI($userId);
    ...
    public function getCaseNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::usernotificationbyctgry($userId, 1);
    ...
    public function getDocsNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::usernotificationbyctgry($userId, 2);
    ...
    public function getSessionNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::usernotificationbyctgry($userId, 3);
    ...
    public function getAccountsNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::usernotificationbyctgry($userId, 4);
