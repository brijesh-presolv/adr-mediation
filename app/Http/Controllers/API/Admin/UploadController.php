    ...
    public function storeMultiFile(Request $request)
    {
        ...
        if ($request->has('docs_party_ids')) {
            ...
            if ($request->shareMediator == 1) {
                ...
                Common_function::MedNotification($request->caseId, "SEND_ADDI_DOC_ADMIN", $userId, isset($mediatorNoti) ? $mediatorNoti->id : null, $inv_id, null, 2, "document");
            } else {
                Common_function::MedNotification($request->caseId, "SEND_ADDI_DOC_ADMIN", $userId, null, $inv_id, null, 2, "document");
            }
