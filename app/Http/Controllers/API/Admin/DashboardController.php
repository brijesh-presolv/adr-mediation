...
class DashboardController extends Controller
{
    ...
    public function getNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::notificationData();
    ...
    public function getCaseNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::notificationDatabyctgry(1);
    ...
    public function getDocsNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::notificationDatabyctgry(2);
    ...
    public function getSessionNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::notificationDatabyctgry(3);
    ...
    public function getAccountsNotifications(Request $request)
    {
        try{
            ...
            $noficationdata = Notification::notificationDatabyctgry(4);
